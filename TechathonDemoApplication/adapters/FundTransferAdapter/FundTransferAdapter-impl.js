...
function getJSONFundTransferFromBackend(clientcard, fromaccount, toaccount, amount){
	WL.Logger.debug("Enter getAccountListFromBackend");
	var input = {
		    method : 'get',
	...
	WL.Logger.debug("Exit getAccountListFromBackend");
		return WL.Server.invokeHttp(input);
